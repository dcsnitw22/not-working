...
// Constants for 5GS Mobile Identity Type
const (
	NoIdentity byte = 0b000
	SUCI       byte = 0b001
	FiveGGUTI  byte = 0b010
	IEMI       byte = 0b011
	TMSI       byte = 0b100
	IEMISV     byte = 0b101
	MAC        byte = 0b110
...
//Constants for SUPI Format
const(
	IMSI          byte = 0b000
	NetworkSpecId byte = 0b001
	GCI           byte = 0b010
	GLI           byte = 0b011

)

//Constants for Protection Scheme ID
const(
   NullScheme byte = 0b0000
   ECIESA     byte = 0b0001
   ECISESB    byte = 0b0010
) 
