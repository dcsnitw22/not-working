...
func (o *Trigger) GetVolumeLimit64() int64 {
...
// and a boolean to check if the value has been set.
func (o *Trigger) GetVolumeLimit64Ok() (*int64, bool) {
	if o == nil || IsNil(o.VolumeLimit64) {
		return nil, false
	}
...
// SetVolumeLimit64 gets a reference to the given int64 and assigns it to the VolumeLimit64 field.
func (o *Trigger) SetVolumeLimit64(v int64) {
	o.VolumeLimit64 = &v
}
