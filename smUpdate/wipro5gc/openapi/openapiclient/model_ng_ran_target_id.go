...
// NgRanTargetId struct for NgRanTargetId
...
func NewNgRanTargetId(ranNodeId interface{}, tai Tai) *NgRanTargetId {
	this := NgRanTargetId{}
...
func (o *NgRanTargetId) GetRanNodeId() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *NgRanTargetId) GetRanNodeIdOk() (*interface{}, bool) {
...
func (o *NgRanTargetId) SetRanNodeId(v interface{}) {
	o.RanNodeId = v
}
