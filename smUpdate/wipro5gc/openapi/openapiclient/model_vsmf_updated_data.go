...
// VsmfUpdatedData struct for VsmfUpdatedData
...
func (o *VsmfUpdatedData) GetAssignedEbiList() []Arp {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdatedData) GetAssignedEbiListOk() ([]Arp, bool) {
	if o == nil || IsNil(o.AssignedEbiList) {
		return nil, false
	}
...
// SetAssignedEbiList gets a reference to the given []Arp and assigns it to the AssignedEbiList field.
func (o *VsmfUpdatedData) SetAssignedEbiList(v []Arp) {
	o.AssignedEbiList = v
}

// GetFailedToAssignEbiList returns the FailedToAssignEbiList field value if set, zero value otherwise.
func (o *VsmfUpdatedData) GetFailedToAssignEbiList() []int32 {
...
// and a boolean to check if the value has been set.
func (o *VsmfUpdatedData) GetFailedToAssignEbiListOk() ([]int32, bool) {
	if o == nil || IsNil(o.FailedToAssignEbiList) {
		return nil, false
	}
...
// SetFailedToAssignEbiList gets a reference to the given []int32 and assigns it to the FailedToAssignEbiList field.
func (o *VsmfUpdatedData) SetFailedToAssignEbiList(v []int32) {
