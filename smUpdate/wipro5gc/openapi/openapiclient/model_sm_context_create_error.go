...
// SmContextCreateError struct for SmContextCreateError
...
func NewSmContextCreateError(error_ ProblemDetails) *SmContextCreateError {
...
func (o *SmContextCreateError) GetError() ProblemDetails {
	if o == nil {
...
func (o *SmContextCreateError) GetErrorOk() (*ProblemDetails, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *SmContextCreateError) SetError(v ProblemDetails) {
	o.Error = v
}
