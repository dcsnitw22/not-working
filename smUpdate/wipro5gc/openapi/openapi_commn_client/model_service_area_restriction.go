...
func (o *ServiceAreaRestriction) GetAreas() []*interface{} {
...
// and a boolean to check if the value has been set.
func (o *ServiceAreaRestriction) GetAreasOk() ([]*interface{}, bool) {
	if o == nil || IsNil(o.Areas) {
		return nil, false
	}
	return o.Areas, true
...
// SetAreas gets a reference to the given []*interface{} and assigns it to the Areas field.
func (o *ServiceAreaRestriction) SetAreas(v []*interface{}) {
	o.Areas = v
}
