...
// SubscriptionsCollectionDocumentAPIService SubscriptionsCollectionDocumentAPI service
type SubscriptionsCollectionDocumentAPIService service

type ApiAMFStatusChangeSubscribeRequest struct {
	ctx context.Context
	ApiService *SubscriptionsCollectionDocumentAPIService
...
*/
func (a *SubscriptionsCollectionDocumentAPIService) AMFStatusChangeSubscribe(ctx context.Context) ApiAMFStatusChangeSubscribeRequest {
	return ApiAMFStatusChangeSubscribeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SubscriptionsCollectionDocumentAPIService) AMFStatusChangeSubscribeExecute(r ApiAMFStatusChangeSubscribeRequest) (*SubscriptionData, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SubscriptionsCollectionDocumentAPIService.AMFStatusChangeSubscribe")
	if err != nil {
