...
type GrpcClientInfoConfig struct {
	ClientIPUpfgw   string
	ClientPortUpfgw string
	ClientIPNgap    string
	ClientPortNgap  string
}
...
var defaultPdusmspConfig = []byte(`
{
        ...
        "N11AmfNodes":[
                {
                        "NodeId": "csp-service.csp.svc.cluster.local",
						"Port": "8083"
                }
        ],
		"GrpcServerInfo":{
		...
		"GrpcClientInfo":{
			"ClientIPUpfgw": "127.0.0.1",
			"ClientPortUpfgw": "50052",
			"ClientIPNgap": "ngap-svc.ngap.svc.cluster.local",
			"ClientPortNgap": "50055"
		}
}`)
