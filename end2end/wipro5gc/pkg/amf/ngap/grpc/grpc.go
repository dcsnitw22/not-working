...
type Grpc interface {
	...
	SendN1N2Data(context.Context, *protos.N1N2Data) (*protos.Error, error)
}
...
func (g *GrpcInfo) SendN1N2Data(ctx context.Context, in *protos.N1N2Data) (*protos.Error, error) {
	return g.GrpcServer.SendN1N2DataTransfer(ctx, in)
}
