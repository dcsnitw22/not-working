...
// NonUeN2InfoSubscriptionCreateData struct for NonUeN2InfoSubscriptionCreateData
...
func (o *NonUeN2InfoSubscriptionCreateData) GetGlobalRanNodeList() []*interface{} {
...
func (o *NonUeN2InfoSubscriptionCreateData) GetGlobalRanNodeListOk() ([]*interface{}, bool) {
	if o == nil || IsNil(o.GlobalRanNodeList) {
		return nil, false
	}
...
func (o *NonUeN2InfoSubscriptionCreateData) SetGlobalRanNodeList(v []*interface{}) {
