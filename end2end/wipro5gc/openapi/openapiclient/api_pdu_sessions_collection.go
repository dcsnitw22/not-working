...
type PDUSessionsCollectionAPI interface {
	...
	*/
	...
	PostPduSessionsExecute(r ApiPostPduSessionsRequest) (*PduSessionCreatedData, *http.Response, error)
}
...
// representation of the PDU session to be created in the H-SMF
