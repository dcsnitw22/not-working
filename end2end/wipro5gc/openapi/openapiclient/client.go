...
// APIClient manages communication with the Nsmf_PDUSession API v1.0.6
...
func selectHeaderContentType(contentTypes []string) string {
	...
	//if statement added by Ruchi
	// if contains(contentTypes, "multipart/form-data") {
...
func selectHeaderAccept(accepts []string) string {
	...
	//if statement added by Ruchi
	// if contains(accepts, "multipart/form-data") {
	// 	return "multipart/form-data"
	// }
...
func (c *APIClient) prepareRequest(
	...
	if strings.HasPrefix(headerParams["Content-Type"], "multipart/form-data") && len(formParams) > 0 || (len(formFiles) > 0) {
		//fmt.Println("Inside multipart/form-data condition in prepareRequest")
		fmt.Println("Length of form files is ", len(formFiles))
		if body != nil {
		...
		//fmt.Println("outside formParams...")
		...
		//fmt.Println("Content Type with Boundary: ", headerParams["Content-Type"])
		// Set Content-Length
	...
	//fmt.Println("After query parameters ...")
	// Generate a new request
	if body != nil {
		localVarRequest, err = http.NewRequest(method, url.String(), body)
		//fmt.Println("Generate a new request: ","Request: ",localVarRequest,"Error: ", err)
	} else {
		//fmt.Println("request body is nil..")
		localVarRequest, err = http.NewRequest(method, url.String(), nil)
		//fmt.Println("request :", localVarRequest, "error :", err)
	}
	if err != nil {
		return nil, err
	}
	...
	fmt.Println("End of prepareRequest function... Returning ", localVarRequest)
