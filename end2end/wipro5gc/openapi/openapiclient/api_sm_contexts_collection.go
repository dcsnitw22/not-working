...
func (r ApiPostSmContextsRequest) JsonData(jsonData SmContextCreateData) ApiPostSmContextsRequest {
	r.jsonData = &jsonData
	//fmt.Println(*(r.jsonData))
	return r
}

func (r ApiPostSmContextsRequest) BinaryDataN1SmMessage(binaryDataN1SmMessage []byte) ApiPostSmContextsRequest {
...
func (r ApiPostSmContextsRequest) Execute() (*SmContextCreatedData, *http.Response, error) {
	//fmt.Println("request data :", r)
	//fmt.Println("sm context data Execute ", r.jsonData)
...
func (a *SMContextsCollectionAPIService) PostSmContextsExecute(r ApiPostSmContextsRequest) (*SmContextCreatedData, *http.Response, error) {
	...
	//localVarHTTPContentTypes := []string{"multipart/form-data", "multipart/related; type='application/json'; boundary=----Boundary", "multipart/related"} //, "application/json"} // 
	...
	if localVarHTTPContentType != "" {
		...
		//added by Ruchi
		fmt.Println("Content-Type: ", localVarHeaderParams["Content-Type"])
	}
	...
	if localVarHTTPHeaderAccept != "" {
		...
		//fmt.Println("Accept: ", localVarHeaderParams["Accept"])
	}
	if r.jsonData != nil {
		paramJson, err := parameterToJson(*r.jsonData)
		//fmt.Println("When r.jsonData is not nil the json data is :", paramJson)
		if err != nil {
			//fmt.Println(paramJson)
			//fmt.Printf("%T", paramJson)
			return localVarReturnValue, nil, err
		} // else {
		// 	fmt.Println("no error in parsing json data...")
		// }
		localVarFormParams.Add("jsonData", paramJson)
		//fmt.Println("localVarFormParams: ", localVarFormParams)
	} //else {
	// 	fmt.Println("json data not found...")
	// 	fmt.Println(r.jsonData)
	// }
	...
	binaryDataN1SmMessageLocalVarFileBytes = r.binaryDataN1SmMessage
	fmt.Println("binaryDataN1SmMessageLocalVarBytes: ", binaryDataN1SmMessageLocalVarFileBytes)
	...
	if binaryDataN1SmMessageLocalVarFileBytes != nil {
		...
		binaryDataN1SmMessageLocalVarFileName = "binaryDataN1SmMessage"
	...
	if err != nil {
		//fmt.Println("Error in preparing request... ", err)
		return localVarReturnValue, nil, err
	}
	...
	//fmt.Println("localVarHTTPResponse Body: ", string(localVarBody), localVarHTTPResponse.StatusCode, localVarHTTPResponse.Status)
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			...
			if err != nil {
				...
				//fmt.Println("Error code 400: ", localVarReturnValue, localVarHTTPResponse, newErr)
