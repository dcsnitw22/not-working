...
// SmContextUpdateError struct for SmContextUpdateError
...
func NewSmContextUpdateError(error_ ProblemDetails) *SmContextUpdateError {
...
func (o *SmContextUpdateError) GetError() ProblemDetails {
	if o == nil {
...
func (o *SmContextUpdateError) GetErrorOk() (*ProblemDetails, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Error, true
...
func (o *SmContextUpdateError) SetError(v ProblemDetails) {
	o.Error = v
}
